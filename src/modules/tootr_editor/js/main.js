define(
	[
		...
		"colorpicker",
		"core/db", 
		"tootr_editor/editable-canvas", 
		"tootr_editor/ui-properties",
		"tootr_editor/ui-timeline",
		"tootr_editor/editable-hotspots"
	],

	function($, Bootstrap, Colorpicker, DB, EditableCanvas, PropertiesUI, TimelineUI, EditableHotspots ) {
		...
		$(function() {
			...
			Main.initialize(function() {
				// Wait until Editor is ready and run it
				Main.run();
			});
		});
