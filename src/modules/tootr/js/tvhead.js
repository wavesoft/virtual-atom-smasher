...
define(
	...
	function($, Popcorn) {
		 ...
		 */
		TVhead.prototype.realign = function( aid ) {
			this.activeAid = aid;
		 ...
		 */
		TVhead.prototype.onSequenceDefined = function(sequence, cb) {
		 ...
		 */
		TVhead.prototype.onStart = function() {
		 ...
		 * interrupted.
		 */
		TVhead.prototype.onStop = function() {
