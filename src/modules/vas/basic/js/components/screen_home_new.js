define(
    ...
    function ($, C, R, User, UI, tpl) {
         ...
         */
        TuningScreen.prototype.handleLevelHover = function( levelConfig, dom ) {
         ...
         */
        TuningScreen.prototype.handleLevelClick = function( levelConfig ) {
         ...
         */
        TuningScreen.prototype.updateLevels = function() {
         ...
         */
        TuningScreen.prototype.setLevels = function( config ) {
            for (var i=1; i<=7; i++) {
         ...
         */
        TuningScreen.prototype.slideTransition = function( direction, configCallback ) {
