...
define(
	...
	// Requirements
	["vas/core/registry", "vas/core/base/components", "text!vas/basic/tpl/overlay/passwordreset.html"],
	...
	function( R,C, tpl) {
		...
		/**
		 * This overlay screen is shown to the user when he/she requests a password reset.
		 *
		 * @class
		 * @classdesc Password reset screen
		 * @registry overlay.passwordreset
		 */
		...
		R.registerComponent( "overlay.passwordreset", PaswordReset, 1 );
