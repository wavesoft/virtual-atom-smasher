...
define(
	...
	[
		...
		"core/ui/view",
		"text!vas/basic/tpl/overlay/register.html" 
	],

	/**
	 * Basic version of the home screen
	 *
	 * @exports vas-basic/overlay/register
	 */
	function($, require, config, R, C, DB, UI, User, View, tplLogin) {
		...
		R.registerComponent( 'overlay.register', RegisterScreen, 1 );
