...
define(
	 ...
	 *
	 * @exports vas-basic/common/tvhead_agent
	 */
	function(require, $, Popcorn, Media, UI, R, VisualAgent, Analytics) {
		...
		Popcorn.plugin( "maskedFocus", function( options ) {
			...
			return {
				start: function(event, track) {
					...
					/**
					 * This event is fired when the interface should focus on
					 * a particular visual aid. 
					 *
				     * @event module:vas-basic/common/tvhead_agent~TVhead#focusVisualAid
				     * @property {string} focus - The visual aid to focus at.
				     * @property {int} timeout - After how much time it shoud be reset.
				     * @property {string} addClass - Which class to add.
				     * @property {string} title - That title to display in addition.
					 */
					...
					/**
					 * This event is fired when the interface should remove the
					 * focus from a previously focused element.
					 *
				     * @event module:vas-basic/common/tvhead_agent~TVhead#blurVisualAid
					 */
		...
		var TVhead = function( hostDOM ) {
			...
			this.skipBtn.click((function() {
				/**
				 * This event is fired when the presentation is completed.
				 *
			     * @event module:vas-basic/common/tvhead_agent~TVhead#completed
				 */
