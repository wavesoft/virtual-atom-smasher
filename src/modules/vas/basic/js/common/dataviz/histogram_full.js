define(
	 ...
	 *
 	 * @exports vas-basic/common/dataviz/histogram_full
	 */
	function(config, d3, R, DataWidget, Calculate) {

		/**
		 * An internal class used for accessing the plot datasets
		 *
		 * @class
		 * @private
		 */
		...
		R.registerComponent( 'dataviz.histogram.full', DataVizFullHistogram, 1 );
