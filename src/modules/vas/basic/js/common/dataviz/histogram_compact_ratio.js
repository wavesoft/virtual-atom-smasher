define(
	 ...
	 *
 	 * @exports vas-basic/common/dataviz/histogram_compact_ratio
	 */
	function(config, d3, R, DataWidget, Calculate) {
		 ...
		 *
		 * @class
		 * @registry dataviz.histogram_ratio.compact
	 	 * @thumbnail doc/Thumbnails/dataviz.histogram_ratio.png
		...
		*/
		...
		R.registerComponent( 'dataviz.histogram_ratio.compact', DataVizHistogram, 1 );
