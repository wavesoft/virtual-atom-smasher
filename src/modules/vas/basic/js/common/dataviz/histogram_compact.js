define(
	...
	// Dependencies
	["jquery", "d3", "vas/core/registry","vas/core/base/data_widget" ], 

	/**
	 * This is the default data widget for visualizing a historgram
	 *
 	 * @exports vas-basic/common/dataviz/histogram_compact
	 */
	function(config, d3, R, DataWidget) {
		...
		*/
		...
		R.registerComponent( 'dataviz.histogram.compact', DataVizHistogram, 1 );
